...
%%% Computes a cumulative minimum energy map from the energy image in the
%%% specified direction specified.
%%% Arguments:      1. energy image
%%%                 2. seam direction
%%%
%%% Returns:        1. map of cumulative minimum energy
